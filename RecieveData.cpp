...
int main() {
	...
	// and no flow control
	SerialPort serialPort("/dev/ttyUSB1", BaudRate::B_57600, NumDataBits::EIGHT, Parity::NONE, NumStopBits::ONE);
	// Use SerialPort serialPort("/dev/ttyACM0", 13000); instead if you want to provide a custom baud rate
	serialPort.SetTimeout(25500); // Block for up to 100ms to receive data
	serialPort.Open();
